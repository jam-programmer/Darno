...
'use strict';
let templateName = "DarnoTemplate";
...
(function () {
  ...
  layoutMenuEl.forEach(function (element) {
    menu = new Menu(element, {
      ...
      // ? This option only works with Horizontal menu
        showDropdownOnHover: localStorage.getItem('templateCustomizer-' + "DarnoTemplate" + '--ShowDropdownOnHover') // If value(showDropdownOnHover) is set in local storage
            ? localStorage.getItem('templateCustomizer-' + "DarnoTemplate" + '--ShowDropdownOnHover') === 'true' // Use the local storage value
      ...
      if (config.enableMenuLocalStorage && !window.Helpers.isSmallScreen()) {
        try {
          localStorage.setItem(
              'templateCustomizer-' + "DarnoTemplate" + '--LayoutCollapsed',
  ...
  if (typeof config !== 'undefined') {
    if (config.enableMenuLocalStorage) {
      try {
        if (
            localStorage.getItem('templateCustomizer-' + "DarnoTemplate" + '--LayoutCollapsed') !== null &&
            localStorage.getItem('templateCustomizer-' + "DarnoTemplate" + '--LayoutCollapsed') !== 'false'
        )
          window.Helpers.setCollapsed(
              localStorage.getItem('templateCustomizer-' + "DarnoTemplate" + '--LayoutCollapsed') === 'true',
            false
          );
      } catch (e) {}
    }
