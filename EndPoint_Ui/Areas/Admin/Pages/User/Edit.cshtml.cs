...
public class EditModel : PageModel
{
    ...
    {
        User = await _userService.GetUserByIdAsync(Id, default);
        ViewData["Roles"] = await _userService.GetUserRolesByIdAsync(Id);
    }
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        try
        {
            await _userService.UpdateUserAsync(User!, default);
